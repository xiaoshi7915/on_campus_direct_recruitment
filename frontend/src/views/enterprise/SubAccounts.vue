        ...
        <table class="w-full">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="account in subAccounts" :key="account.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ account.company_name }}</td>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ formatDate(account.created_at) }}</td>
