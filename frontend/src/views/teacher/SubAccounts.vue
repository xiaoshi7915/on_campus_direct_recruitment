<template>
  <div class="sub-accounts-page max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <table class="w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="account in subAccounts" :key="account.id" class="hover:bg-gray-50 transition-colors duration-200">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ account.real_name }}</td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                  ...
                  <div class="text-xs text-gray-500">{{ account.position || '-' }}</div>
                </td>
