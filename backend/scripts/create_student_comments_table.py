    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(text("""
            CREATE TABLE IF NOT EXISTS `student_comments` (
                ...
                CONSTRAINT `fk_student_comments_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_profiles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
                CONSTRAINT `fk_student_comments_student` FOREIGN KEY (`student_id`) REFERENCES `student_profiles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
